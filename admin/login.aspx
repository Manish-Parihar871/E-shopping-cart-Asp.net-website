			...
			<div class="row">
              	...
              	<div class="col-sm-4 col-sm-offset-1" >
					<div class="login-form"><!--login form-->
						...
						<li><br /></li>
                            <li> <asp:Button type="submit" runat="server" Id="Button1" class="btn btn-default" Text ="Forget pass word " style="background: #FE980F;" OnClick="Button1_Click"></asp:Button></li>
                            <li><br /></li>
                                 </ul>
					</div><!--/login form-->
                    </div>
